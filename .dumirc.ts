...
const themeConfig: SiteThemeConfig = {
  ...
  apiHeader: {
    sourceUrl: `https://github.com/eternallycyf/ims-keep-alive/tree/master/src/components/{atomId}/index.tsx`,
    docUrl: `https://github.com/eternallycyf/ims-keep-alive/tree/master/src/components/{atomId}/index.md`,
    pkg: 'ims-keep-alive',
    match: ['/ims-keep-alive/src/component'],
  },
  footerConfig: {
    bottom: '2023',
